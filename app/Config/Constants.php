...
defined('MAX_FILE_SIZE')              || define('MAX_FILE_SIZE', (10 * 1024 * 1024)); // 10 MB

defined('ALLOWED_TYPES')              || define('ALLOWED_TYPES', [
  'image/jpeg',
  'image/png',
  'image/gif',
  'image/webp',
...
defined('ALLOWED_TYPES_IMAGES')       || define('ALLOWED_TYPES_IMAGES', [
  'image/jpeg',
  'image/png',
  'image/gif',
  'image/webp'
...
defined('UPLOAD_URL')                 || define('UPLOAD_URL', BASE_URL . 'arquivos/upload');
defined('REMOVE_USER_IMAGE_URL')      || define('REMOVE_USER_IMAGE_URL', BASE_URL . 'arquivos/removeUserImage');
defined('DELETE_TEMPORARY_IMAGE_URL') || define('DELETE_TEMPORARY_IMAGE_URL', BASE_URL . 'arquivos/deleteTemporaryImage');
defined('SEM_IMAGEM')                 || define('SEM_IMAGEM', '/img/sem-imagem.png'); 
