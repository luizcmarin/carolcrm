...
class EstadoProvinciasModel extends Model
{
    use AuditoriaTrait;

    protected $table           = 'estado_provincias';
    protected $primaryKey      = 'id';
    protected $useAutoIncrement = true;
    protected $returnType      = 'App\Entities\EstadoProvincia';
    protected $useSoftDeletes  = false;
    protected $protectFields   = true;
    protected $allowedFields   = ['nome', 'abreviatura', 'pais_id', 'created_at', 'updated_at', 'criado_em', 'editado_em'];
