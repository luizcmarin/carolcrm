...
class PermissaoUsuariosModel extends Model
{
    protected $table           = 'permissao_usuarios';
    protected $primaryKey      = 'id';
    protected $useAutoIncrement = true;
    protected $returnType      = 'App\Entities\PermissaoUsuario';
    protected $useSoftDeletes  = true;
    protected $protectFields   = true;
    protected $allowedFields   = ['usuario_id', 'permissao', 'criado_em', 'atualizado_em', 'deletado_em'];
