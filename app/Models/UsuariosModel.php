...
class UsuariosModel extends Model
{
    ...
    protected $allowedFields   = ['grupo_usuario_id', 'nome', 'status', 'mensagem_status', 'ativo', 'ultimo_acesso', 'criado_em', 'atualizado_em', 'deletado_em', 'expira_em', 'senha'];
    ...
    protected $validationRules = [
            ...
            'nome' => [
                ...
                'errors' => 'O campo {field} é obrigatório.|O campo {field} deve ter no máximo 255 caracteres.',
            ],
            'status' => [
                'label' => 'Status',
                'rules' => 'permit_empty',    
            ...
            'senha' => [
                'label' => 'Senha',
                'rules' => 'permit_empty|max_length[255]|min_length[8]',    
                'errors' => 'O campo {field} deve ter no máximo 255 caracteres.|O campo {field} é inválido.',
            ],
    ];
