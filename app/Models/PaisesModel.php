...
class PaisesModel extends Model
{
    ...
    protected $allowedFields   = ['iso2', 'nome_curto', 'nome_longo', 'iso3', 'codigo_numerico', 'codigo_chamada', 'cctld', 'created_at', 'updated_at', 'criado_em', 'editado_em'];
