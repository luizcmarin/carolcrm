...
class LoginsModel extends Model
{
    ...
    protected $returnType      = 'App\Entities\Logim';
    protected $useSoftDeletes  = true;
    protected $protectFields   = true;
    protected $allowedFields   = ['endereco_ip', 'user_agent', 'usuario', 'data_tentativa', 'sucesso', 'criado_em', 'atualizado_em', 'deletado_em'];
    ...
    protected $validationRules = [
            ...
            'data_tentativa' => [
                ...
                'errors' => 'O campo {field} deve ser uma data válida no formato YYYY-MM-DD.',
            ],
            'sucesso' => [
                'label' => 'Sucesso',
