...
class UsuarioGruposModel extends Model
{
    use AuditoriaTrait;
    ...
    protected $returnType      = 'App\Entities\UsuarioGrupo';
    protected $useSoftDeletes  = false;
    protected $protectFields   = true;
    protected $allowedFields   = ['nome', 'created_at', 'updated_at', 'criado_em', 'editado_em'];
