...
class ConfiguracoesModel extends Model
{
    ...
    protected $allowedFields   = ['chave', 'categoria', 'valor', 'descricao', 'sn_sistema', 'tipo', 'created_at', 'updated_at', 'criado_em', 'editado_em'];
    ...
    public function getCampo(string $fieldName, array $conditions = [])
    {
        ...
        return null; // Retorna null se o registro não for encontrado ou o campo não existir
    }
