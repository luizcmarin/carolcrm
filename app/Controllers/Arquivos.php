    ...
    public function delete(int $id): string|ResponseInterface
    {
      ...
      $nome = $this->model->getCampo('nome', ['id' => $id]);
        ...
        if ($this->model->delete($id)) {
            $this->logAtividadesModel->addLog('Arquivos: registro excluído [' . $id . '-' . $nome . ']');
            return redirect()->to('/arquivos')->with('success', 'Registro excluído com sucesso!');
        } else {
