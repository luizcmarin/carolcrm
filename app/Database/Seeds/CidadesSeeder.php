...
class CidadesSeeder extends Seeder
{
    public function run()
    {
        ...
        // $this->db->table('cidades')->truncate(); // Descomente para limpar antes de inserir
        if (!empty($data)) {
            ...
            // $this->db->table('cidades')->where('id IS NOT NULL')->delete(); // Exemplo: limpar a tabela se o seed for vazio
        }
    }
}