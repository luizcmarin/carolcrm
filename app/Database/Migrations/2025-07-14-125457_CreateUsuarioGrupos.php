...
class CreateUsuarioGrupos extends Migration
{
    public function up()
    {
        $this->forge->addField([
        ...
        $this->forge->addForeignKey('id', 'usuarios', 'usuario_grupo_id'->onDelete('RESTRICT')->onUpdate('CASCADE'));

        $this->forge->createTable('usuario_grupos');
    }

    public function down()
    {
        $this->forge->dropTable('usuario_grupos');
    }
}