...
<div class="container-fluid">
  ...
  <div class="card shadow mb-4">
    ...
    <div class="card-body">
      <form action="/permissaousuarios/create" method="post">
          <?= csrf_field() ?>
        ...
        <?php endif ?>
                    ...
                    <input type="text" class="form-control" id="permissao" name="permissao" placeholder="Permissao" value="<?= old('permissao') ?>" required>
