    ...
    <div class="container-fluid">
      ...
      <div class="card shadow mb-4">
        ...
        <div class="card-body">
          <p><strong>Chave:</strong> <?= $registros->chave ?></p>
          <p><strong>Categoria:</strong> <?= $registros->categoria ?></p>
          <p><strong>Valor:</strong> <?= $registros->valor ?></p>
          <p><strong>Descrição:</strong> <?= $registros->descricao ?></p>
          <p><strong>Tipo:</strong> <?= $registros->tipo ?></p>
          <p><strong>Sistema:</strong> <?= $registros->sn_sistema ?></p>
          <div class="d-flex justify-content-start mt-4">
            <?php if (service('Carol')->pode('CONFIGURACOES.EDITAR')) : ?>
              <a href="/configuracoes/<?= $registros->id ?>/edit ?>" class="btn btn-warning ms-1">
