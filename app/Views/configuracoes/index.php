        ...
        <div class="d-sm-flex align-items-center">
            ...
            <div class="col-md-auto">
                <?php if (service('Carol')->pode('CONFIGURACOES.NOVO')) : ?>
                    <a href="<?= base_url('configuracoes/new') ?>" class="btn btn-primary shadow-sm">
                        ...
                        <?php if (!empty($registros)): ?>
                            <?php foreach ($registros as $registro): ?>
                                <tr>
                                    ...
                                    <td><?= $registro->tipo ?></td>
                                    <td><?= $registro->sn_sistema ?></td>
                                    <td>
                                        <?php if (service('Carol')->pode('CONFIGURACOES.VER')) : ?>
                                            <a href="<?= base_url('configuracoes/' . $registro->id) . '/show' ?>" class="btn btn-info btn-sm" title="Detalhes">
                                                <i class="bi bi-eye"></i>
                                            </a>
                                        <?php endif; ?>

                                        <?php if (service('Carol')->pode('CONFIGURACOES.EDITAR')) : ?>
                                            <a href="<?= base_url('configuracoes/' . $registro->id . '/edit') ?>" class="btn btn-warning btn-sm" title="Editar">
                                                <i class="bi bi-pencil"></i>
                                            </a>
                                        <?php endif; ?>

                                        <?php if (service('Carol')->pode('CONFIGURACOES.EXCLUIR')) : ?>
                                            <form action="<?= base_url('configuracoes/' . $registro->id) ?>" method="POST" class="d-inline form-delete">
                                                <?= csrf_field() ?>
