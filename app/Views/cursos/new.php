...
<div class="container-fluid">
  ...
  <div class="card shadow mb-4">
    ...
    <div class="card-body">
      <form action="<?= base_url('cursos') ?>" method="post">
        <?= csrf_field() ?>
        ...
        <div class="form-floating mb-3 position-relative input-with-copy">
          <div class="form-group mb-3">
            ...
            <textarea class="form-control" id="texto" name="texto" rows="10" placeholder="Digite seu texto aqui..." required><?= old('texto') ?></textarea>
          </div>
          <label for="texto">Texto</label>
          <button class="btn btn-sm btn-light copy-button-textarea" type="button"
