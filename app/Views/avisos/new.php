    ...
    <div class="card-body">
      <form action="<?= base_url('avisos') ?>" method="post">
          <?= csrf_field() ?>
                  ...
                  <input type="text" class="form-control" id="mensagem" name="mensagem" placeholder="Mensagem" value="<?= old('mensagem') ?>" >
          ...
          <div class="d-flex justify-content-start mt-3">
              <?php if (service('Carol')->pode('AVISOS.NOVO')) : ?>
