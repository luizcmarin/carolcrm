    ...
    <div class="container-fluid">
      ...
      <div class="card shadow mb-4">
        ...
        <div class="card-body">
              <p><strong>Nome:</strong> <?= $registros->nome ?></p>    <p><strong>Estado Id:</strong> <?= $registros->estado_nome ?? 'N/A' ?></p>    <p><strong>Criado Em:</strong> <?= $registros->criado_em ?></p>    <p><strong>Editado Em:</strong> <?= $registros->editado_em ?></p>
          <div class="d-flex justify-content-start mt-4">
              <?php if (service('Carol')->pode('CIDADES.EDITAR')) : ?>
              <a href="/cidades/<?= $registros->id ?>/edit ?>" class="btn btn-warning ms-1">
