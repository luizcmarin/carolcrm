    ...
    <div class="card-body">
      <form action="<?= base_url('usuarios') ?>" method="post">
        ...
        <?php endif ?>
                  ...
                  <input type="text" class="form-control" id="imagem_perfil" name="imagem_perfil" placeholder="Imagem Perfil" value="<?= old('imagem_perfil') ?>" >
                  ...
                  <input type="text" class="form-control" id="sobre" name="sobre" placeholder="Sobre" value="<?= old('sobre') ?>" >
        ...
        <?php endif ?>
                  ...
                  <input type="text" class="form-control" id="redes_sociais" name="redes_sociais" placeholder="Redes Sociais" value="<?= old('redes_sociais') ?>" >
                  ...
                  <input type="text" class="form-control" id="genero" name="genero" placeholder="Genero" value="<?= old('genero') ?>" >
        ...
        <?php endif ?>
                  ...
                  <input type="text" class="form-control" id="senha" name="senha" placeholder="Senha" value="<?= old('senha') ?>" required>
                  ...
                  <input type="text" class="form-control" id="ultimo_ip" name="ultimo_ip" placeholder="Ultimo Ip" value="<?= old('ultimo_ip') ?>" >
                  <label for="ultimo_ip">Ultimo Ip</label>
                    ...
                    <input type="date" class="form-control datepicker-input" id="data_ultimo_login" name="data_ultimo_login" placeholder="Data Ultimo Login" 
                        value="<?= old('data_ultimo_login', $value ?? '') ?>" 
                        >
