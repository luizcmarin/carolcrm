...
<div class="container-fluid">
  ...
  <div class="card shadow mb-4">
    ...
    <div class="card-body">
      <form action="/usuarios/update/<?= $usuarios->id ?>" method="post">
          <?= csrf_field() ?>
          <input type="hidden" name="_method" value="PUT">
                    ...
                    <input type="text" class="form-control" id="nome" name="nome" placeholder="Nome" value="<?= old('nome', $usuarios->nome) ?>" required>
                ...
                <textarea class="form-control" id="status" name="status" placeholder="Status" style="height: 100px" >
                    <?= old('status', (isset($value) && $value !== null) ? esc($value) : '') ?>
                </textarea>
                ...
                <textarea class="form-control" id="mensagem_status" name="mensagem_status" placeholder="Mensagem Status" style="height: 100px" >
                    <?= old('mensagem_status', (isset($value) && $value !== null) ? esc($value) : '') ?>
                </textarea>
                ...
                <?php endif ?>
                    ...
                    <input class="form-check-input" type="checkbox" role="switch" 
                           ...
                           value="Sim" 
                           <?php 
                               // Esta lógica será executada PELA VIEW, não pelo fazer.php
                               $currentValue = old('ativo', $value ?? null);
                               if ($currentValue === 'Sim') {
                                   echo 'checked';
                               }
                           ?> >
            ...
            <?php endif ?>
                    ...
                    <input type="text" class="form-control" id="ultimo_acesso" name="ultimo_acesso" placeholder="Ultimo Acesso" value="<?= old('ultimo_acesso', $usuarios->ultimo_acesso) ?>" >
                    ...
                    <input type="text" class="form-control" id="criado_em" name="criado_em" placeholder="Criado Em" value="<?= old('criado_em', $usuarios->criado_em) ?>" >
                    ...
                    <input type="text" class="form-control" id="atualizado_em" name="atualizado_em" placeholder="Atualizado Em" value="<?= old('atualizado_em', $usuarios->atualizado_em) ?>" >
                    ...
                    <input type="text" class="form-control" id="deletado_em" name="deletado_em" placeholder="Deletado Em" value="<?= old('deletado_em', $usuarios->deletado_em) ?>" >
                ...
                <textarea class="form-control" id="expira_em" name="expira_em" placeholder="Expira Em" style="height: 100px" >
                    <?= old('expira_em', (isset($value) && $value !== null) ? esc($value) : '') ?>
                </textarea>
                ...
                <?php endif ?>
                    ...
                    <input type="text" class="form-control" id="senha" name="senha" placeholder="Senha" value="<?= old('senha', $usuarios->senha) ?>" >
