    ...
    <div class="container-fluid">
      ...
      <div class="card shadow mb-4">
        ...
        <div class="card-body">
              <p><strong>Nome Usuario:</strong> <?= $registros->nome_usuario ?></p>    <p><strong>Atividade:</strong> <?= $registros->atividade ?></p>    <p><strong>Criado Em:</strong> <?= $registros->criado_em ?></p>    <p><strong>Editado Em:</strong> <?= $registros->editado_em ?></p>
          <div class="d-flex justify-content-start mt-4">
              <?php if (service('Carol')->pode('LOGATIVIDADES.EDITAR')) : ?>
              <a href="/logatividades/<?= $registros->id ?>/edit ?>" class="btn btn-warning ms-1">
