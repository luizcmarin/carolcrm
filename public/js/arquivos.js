document.addEventListener('DOMContentLoaded', function () {
  ...
  const cancelNewFileUploadButton = document.getElementById('cancelNewFileUploadButton');
  ...
  function processFile(file) {
    ...
    cancelNewFileUploadButton.disabled = true;
    showMessage('');
    ...
    uploadButton.addEventListener('click', async function (event) {
      ...
      try {
        ...
        if (response.ok) {
          ...
          cancelNewFileUploadButton.disabled = false;
  ...
  if (cancelNewFileUploadButton) {
    cancelNewFileUploadButton.addEventListener('click', async function () {
